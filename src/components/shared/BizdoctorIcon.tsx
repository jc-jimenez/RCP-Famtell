...
export default function BizdoctorIcon({ size = 32, className }: Props) {
  return (
    ...
    >
      <defs>
        <clipPath id="bd-heart1-left"><rect x="0" y="0" width="102" height="200" /></clipPath>
        <clipPath id="bd-heart1-right"><rect x="102" y="0" width="98" height="200" /></clipPath>
        <clipPath id="bd-heart2-left"><rect x="0" y="0" width="126" height="200" /></clipPath>
        <clipPath id="bd-heart2-right"><rect x="126" y="0" width="74" height="200" /></clipPath>
        <clipPath id="bd-pulse-clip">
      ...
      <g transform="translate(88,78) scale(3.3)" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        <path d={HEART_D} stroke="#FBBC05" clipPath="url(#bd-heart2-left)" />
        <path d={HEART_D} stroke="#34A853" clipPath="url(#bd-heart2-right)" />
      </g>
      ...
      <g transform="translate(30,10) scale(6)" strokeWidth="0.95" strokeLinecap="round" strokeLinejoin="round">
        <path d={HEART_D} stroke="#4285F4" clipPath="url(#bd-heart1-left)" />
        <path d={HEART_D} stroke="#EA4335" clipPath="url(#bd-heart1-right)" />
      </g>

      {/* Línea de pulso, recortada al interior del corazón principal */}
      <g clipPath="url(#bd-pulse-clip)">
        <polyline
